                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <form id="form_das" action="<?= base_url('editar-solicitud-instituto'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body collapse show">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Nombres</label>
                                                    <input name="ins_name_fam" type="text" class="form-control" placeholder="Nombres" value="<?= $r->ins_name_fam ?>">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Apellidos</label>
                                                    <input name="ins_last_fam" type="text" class="form-control" placeholder="Apellidos" value="<?= $r->ins_last_fam ?>">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input name="ins_cift_fam" type="text" class="form-control" placeholder="N° CIF" value="<?= $r->ins_cift_fam ?>">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">Correo Electrónico</label>
                                                    <input name="ins_email_fam" type="text" class="form-control" placeholder="Correo Electrónico" value="<?= $r->ins_email_fam ?>">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-4">
                                        ...
                                        <div class="row p-t-20">
                                                    ...
                                                    <select name="institut" class="select2 form-control form-select" style="width: 100%; height:36px;">
                                                        ...
                                                        <optgroup label="Instituto">
                                                            ...
                                                            foreach ($institutes as $institute) {
                                                                ...
                                                                if ($institute->id_institute == $r->institute) {
                                                                    echo '<option value="' . $institute->id_institute . '"selected>' . $institute->name_institute . '</option>';
                                                                } else {
                                                        ...
                                                        <optgroup label="Academia">
                                                            ...
                                                            foreach ($academies as $academy) {
                                                                ...
                                                                if ($academies->id_institute == $r->institute) {
                                                                    echo '<option value="' . $academy->id_institute . '"selected>' . $academy->name_institute . '</option>';
                                                                } else {
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="ins_specialty" type="text" class="form-control" placeholder="Especialidad" value="<?= $r->ins_specialty ?>">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                ...
                                <div class="card" id="data_ingr" <?= $d['style'] ?>>
                                    <div class="card-header text-white bg-info">
                                        <b id="titleCard">Documentos de Familiar</b>
                                        <div class="card-actions">
                                            <a class="text-white" data-action="collapse"><i class="ti-minus"></i></a>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                <div class="card center">
                                                    <div class="card-body">
                                                        ...
                                                        <input type="file" name="ins_cif_fam" id="input-file-now1" class="dropify" data-default-file="<?= $d['path'] . "" . $r->ins_cif_fam ?>" value="<?= $r->ins_cif_fam ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <input type="file" name="ins_dni_fam" id="input-file-now1" class="dropify" data-default-file="<?= $d['path'] . "" . $r->ins_dni_fam ?>" value="<?= $r->ins_dni_fam ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
