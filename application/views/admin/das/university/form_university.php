                        ...
                        <div class="col-12">
                            ...
                            <form id="form_das" action="<?= base_url('guardar-registro-universidad'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body collapse show">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Nombres</label>
                                                    <input name="uni_name_fam" type="text" class="form-control" placeholder="Nombres" value="">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Apellidos</label>
                                                    <input name="uni_last_fam" type="text" class="form-control" placeholder="Apellidos" value="">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input name="uni_cift_fam" type="text" class="form-control" placeholder="N° CIF" value="">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">Correo Electrónico</label>
                                                    <input name="uni_email_fam" type="text" class="form-control" placeholder="Correo Electrónico" value="">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-4">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input name="uni_specialty" type="text" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                ...
                                <div class="card" id="data_ingr">
                                    ...
                                    <div class="card-body collapse show">
                                        <div class="row p-t-20">
                                            <div class="col-md-6" id="data_trasl" style="display: none;">
                                                <div class="card center">
                                                    <div class="card-body">
                                                        <h4 class="card-title">Copias de Consolidado de notas (último ciclo)</h4>
                                                        <input type="file" name="uni_grades" id="input-file-now1" class="dropify" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6" id="d_settlement">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h4 class="card-title">Copia de Constancia de Ingreso de la Univ.</h4>
                                                        <input type="file" name="uni_settlement" id="input-file-now1" class="dropify" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6" id="d_tuition">
                                                <div class="card center">
                                                    <div class="card-body">
                                                        ...
                                                        <input type="file" name="uni_tuition" id="input-file-now1" class="dropify" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                <div class="card center">
                                                    <div class="card-body">
                                                        ...
                                                        <input type="file" name="uni_cif_fam" id="input-file-now1" class="dropify" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <input type="file" name="uni_dni_fam" id="input-file-now1" class="dropify" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
